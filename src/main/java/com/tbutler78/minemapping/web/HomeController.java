...
public class HomeController {
	...
	@RequestMapping(value="/mines/{county}")
	public ResponseEntity<MineCommand> getMines(@PathVariable String county){
		return buildResponse(new MineCommand(mineService.findByCounty(county)));
	}
